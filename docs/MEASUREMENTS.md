...
The package packs to 329,250 bytes across 130 files, 29,150 bytes under its
358,400-byte ceiling, with 0 runtime and 0 development dependencies. The
...
| The lab in the package | 20 files under tools/lab/, 163,753 bytes unpacked, and since the first-user test of 2026-09-19 the suites' inputs, 23 files, 51,479 bytes; the package packs to 329,250 bytes across 130 files under the 358,400-byte ceiling | `npm pack --dry-run --json`, `tests/package-assert.mjs`. |
