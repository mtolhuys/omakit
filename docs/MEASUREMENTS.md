...
The package packs to 329,279 bytes across 130 files, 29,121 bytes under its
...
| The lab in the package | 20 files under tools/lab/, 163,753 bytes unpacked, and since the first-user test of 2026-09-19 the suites' inputs, 23 files, 51,479 bytes; the package packs to 329,279 bytes across 130 files under the 358,400-byte ceiling | `npm pack --dry-run --json`, `tests/package-assert.mjs`. |
