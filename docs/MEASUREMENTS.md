...
| The lab in the package | 20 files, 163,753 bytes unpacked; the package packs to 310,081 bytes across 105 files under the 358,400-byte ceiling | `npm pack --dry-run --json`, `tests/package-assert.mjs`. |
